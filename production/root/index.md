...
- `app/`
  - `app/fetch-erc20-demo/index.html` - static embedded-browser orchestration demo
- `src/`
- `utils/`
- `docs/`
- `fetch-erc20-spec.md` - external build prompt and collapsible organisation task tree append
- `README.md`
- `AGENT_INIT.md`
